...
def run_recorder(opts):
    ...
    while not esc:
        ...
        while not done:
            ...
            while action is None:
                ...
                if keys_pressed == 'f': #Why 'is' didn't work?
                    esc = True
                    break
            ...
            print('len(sarsa_pairs: ', len(sarsa_pairs))
    ...
    print('len(sarsa_pairs): ', len(sarsa_pairs))
    print('len(sarsa_paris)/SHARD_SIZE ', len(sarsa_pairs)/SHARD_SIZE)
    ...
    for shard_iter in range(num_shards):
        ...
        np.save(os.path.join(ddir, shard_name), sarsa_pairs)
